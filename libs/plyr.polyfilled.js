typeof navigator === "object" &&
  (function (global, factory) {
      ...
      function e(t, n) {
        (_classCallCheck(this, e),
          ...
          is$1.element(this.element) &&
            ...
            ((this.config = _objectSpread2({}, defaults$1, {}, n)),
            this.init()));
      }
      return (
        _createClass(
                ...
                if (
                  (is$1.empty(t) || is$1.string(t)
                    ...
                    : is$1.element(t)
                      ...
                      : is$1.nodeList(t)
                        ? (r = Array.from(t))
                        : is$1.array(t) && (r = t.filter(is$1.element)),
                  is$1.empty(r))
                )
                  return null;
    ...
    function getAspectRatio(input) {
      const parse = (ratio) =>
        validateAspectRatio(ratio) ? ratio.split(":").map(Number) : null;
      // Try provided ratio
        ...
        Object.defineProperty(player.media, "quality", {
          get() {
            ...
            const source = sources.find(
              (s) => s.getAttribute("src") === player.source,
            );
          ...
          set(input) {
            ...
            if (
              ...
              is.function(player.config.quality.onChange)
            ) {
              ...
              const source = sources.find(
                (s) => Number(s.getAttribute("size")) === input,
              );
    ...
    const controls = {
      ...
      getIconUrl() {
        ...
        const cors =
          url.host !== host || (browser.isIE && !window.svg4everybody);
        return {
      ...
      createButton(buttonType, attr) {
        ...
        if (Object.keys(attributes).includes("class")) {
          if (
            !attributes.class
              .split(" ")
              .some((c) => c === this.config.classNames.control)
          ) {
            extend(attributes, {
      ...
      createTime(type, attrs) {
        ...
        const container = createElement(
          ...
          extend(attributes, {
            class:
              `${attributes.class ? attributes.class : ""} ${this.config.classNames.display.time} `.trim(),
            "aria-label": i18n.get(type, this.config),
            role: "timer",
          }),
          "00:00",
      ...
      bindMenuItemShortcuts(menuItem, type) {
        ...
        on.call(
          ...
          (event) => {
            ...
            if (
              ![" ", "ArrowUp", "ArrowDown", "ArrowRight"].includes(event.key)
            ) {
              return;
            }
            ...
            if (!isRadioButton && [" ", "ArrowRight"].includes(event.key)) {
              ...
              if (event.key !== " ") {
                if (
                  event.key === "ArrowDown" ||
                  (isRadioButton && event.key === "ArrowRight")
                ) {
      ...
      createMenuItem({
        ...
        const menuItem = createElement(
          ...
          extend(attributes, {
            ...
            role: "menuitemradio",
            class:
              `${this.config.classNames.control} ${attributes.class ? attributes.class : ""}`.trim(),
      ...
      updateSeekTooltip(event) {
        ...
        const point =
          (_this$config$markers = this.config.markers) === null ||
          _this$config$markers === void 0
            ? void 0
            : (_this$config$markers$ = _this$config$markers.points) === null ||
                _this$config$markers$ === void 0
              ? void 0
              : _this$config$markers$.find(
                  ({ time: t }) => t === Math.round(time),
                );
      ...
      focusFirstMenuItem(pane, focusVisible = false) {
        ...
        let target = pane;
        if (!is.element(target)) {
          target = Object.values(this.elements.settings.panels).find(
            (p) => !p.hidden,
          );
        }
      ...
      toggleMenu(input) {
        ...
        if (is.boolean(input)) {
          ...
          const target = is.function(input.composedPath)
      ...
      create(data) {
        ...
        dedupe(
          ...
          if (control === "download") {
            ...
            container.appendChild(
              createButton.call(this, "download", attributes),
            );
          }
      ...
      setMarkers() {
        ...
        // Get valid points
        const points =
          (_this$config$markers2 = this.config.markers) === null ||
          _this$config$markers2 === void 0
            ? void 0
            : (_this$config$markers3 = _this$config$markers2.points) === null ||
                _this$config$markers3 === void 0
              ? void 0
              : _this$config$markers3.filter(
                  ({ time }) => time > 0 && time < this.duration,
                );
    ...
    const captions = {
      ...
      setup() {
        ...
        const languages = dedupe(
          browserLanguages.map((language) => language.split("-")[0]),
        );
        let language = (
        ...
        if (this.isHTML5) {
          const trackEvents = this.config.captions.update
      ...
      getTracks(update = false) {
        ...
        return tracks
          .filter(
            (track) => !this.isHTML5 || update || this.captions.meta.has(track),
          )
      ...
      findTrack(languages, force = false) {
        ...
        const sorted = Array.from(tracks).sort(
          (a, b) => sortIsDefault(b) - sortIsDefault(a),
        );
        let track;
    ...
    class Fullscreen {
      constructor(player) {
        ...
        on.call(
          ...
          (event) => {
            ...
            if (
              ...
              this.player.elements.controls.contains(event.target)
            ) {
              return;
            }
        ...
        on.call(this, this.player.elements.container, "keydown", (event) =>
    ...
    const ui = {
      ...
      migrateStyles() {
        ...
        Object.values({
          ...
          .filter(
            (key) =>
              !is.empty(key) && is.string(key) && key.startsWith("--plyr"),
          )
          .forEach((key) => {
            // Set on the container
            this.elements.container.style.setProperty(
              key,
              this.media.style.getPropertyValue(key),
            );
      ...
      constructor(_player) {
        ...
        _defineProperty$1(this, "container", () => {
          ...
          const setGutter = () => {
            ...
            const useNativeAspectRatio = supportsCSS(
            ...
            if (useNativeAspectRatio) {
              ...
              target.style.maxWidth = overflow
                ? `${(viewportHeight / videoHeight) * videoWidth}px`
                : null;
        ...
        _defineProperty$1(this, "media", () => {
          ...
          on.call(
            ...
            (event) => ui.checkLoading.call(player, event),
          );
        ...
        _defineProperty$1(
          this,
          "proxy",
          (event, defaultHandler, customHandlerKey) => {
            const { player } = this;
        ...
        _defineProperty$1(
          this,
          "bind",
          (element, type, defaultHandler, customHandlerKey, passive = true) => {
            const { player } = this;
            const customHandler = player.config.listeners[customHandlerKey];
            const hasCustomHandler = is.function(customHandler);
            on.call(
        ...
        _defineProperty$1(this, "controls", () => {
          ...
          // Captions toggle
          this.bind(elements.buttons.captions, "click", () =>
          ...
          this.bind(
            ...
            (event) => {
              ...
              const [x, y] = [event.deltaX, -event.deltaY].map((value) =>
      ...
      ready() {
        ...
        Object.defineProperty(player.media, "muted", {
          ...
          set(input) {
            ...
            player.embed
              .setMuted(toggle ? true : player.config.muted)
              .then(() => {
                muted = toggle;
                triggerEvent.call(player, player.media, "volumechange");
              });
    ...
    const youtube = {
      ...
      ready() {
        ...
        if (config.customControls) {
          const posterSrc = (s) =>
            `https://i.ytimg.com/vi/${videoId}/${s}default.jpg`;
        ...
        player.embed = new window.YT.Player(player.media, {
          ...
          playerVars: extend(
            {},
            {
              ...
              playsinline:
                player.config.playsinline && !player.config.fullscreen.iosNative
                  ? 1
                  : 0,
          ...
          events: {
            ...
            onReady(event) {
              ...
              player.options.speed = speeds.filter((s) =>
                player.config.speed.options.includes(s),
              );
            ...
            onStateChange(event) {
              ...
              const seeked =
                player.media.seeking && [1, 2].includes(event.data);
              if (seeked) {
      ...
      constructor(player) {
        ...
        _defineProperty$1(this, "onAdsManagerLoaded", (event) => {
          ...
          Object.keys(google.ima.AdEvent.Type).forEach((type) => {
            this.manager.addEventListener(google.ima.AdEvent.Type[type], (e) =>
              this.onAdEvent(e),
            );
          });
        ...
        _defineProperty$1(this, "onAdEvent", (event) => {
          ...
          const dispatchEvent = (type) => {
            triggerEvent.call(
              this.player,
              this.player.media,
              `ads${type.replace(/_/g, "").toLowerCase()}`,
            );
          };
      ...
      constructor(player) {
        ...
        _defineProperty$1(this, "startMove", (event) => {
          ...
          if (event.type === "touchmove") {
            ...
            // Get marker point for time
            const point =
              (_this$player$config$m = this.player.config.markers) === null ||
              _this$player$config$m === void 0
                ? void 0
                : (_this$player$config$m2 = _this$player$config$m.points) ===
                      null || _this$player$config$m2 === void 0
                  ? void 0
                  : _this$player$config$m2.find(
        ...
        _defineProperty$1(this, "startScrubbing", (event) => {
          ...
          if (
            is.nullOrUndefined(event.button) ||
            event.button === false ||
            event.button === 0
          ) {
            this.mouseDown = true;
        ...
        _defineProperty$1(this, "showImageAtCurrentTime", () => {
          ...
          const thumbNum = this.thumbnails[0].frames.findIndex(
            (frame) =>
              this.seekTime >= frame.startTime &&
              this.seekTime <= frame.endTime,
          );
          ...
          Array.from(this.currentImageContainer.children).forEach((image) => {
            ...
            if (
              ...
              setTimeout(() => {
                ...
                this.player.debug.log(
                  `Removing thumb: ${image.dataset.filename}`,
                );
              }, removeDelay);
            }
          });
            ...
            setTimeout(() => {
              ...
              if (this.showingThumbFilename === oldThumbFilename) {
                ...
                if (forward) {
                  ...
                  thumbnailsClone = this.thumbnails[0].frames
                    .slice(0, thumbNum)
                    .reverse();
                }
                let foundOne = false;
                thumbnailsClone.forEach((frame) => {
                  ...
                  if (newThumbFilename !== oldThumbFilename) {
                    ...
                    if (!this.loadedImages.includes(newThumbFilename)) {
                      foundOne = true;
                      this.player.debug.log(
                        `Preloading thumb filename: ${newThumbFilename}`,
                      );
                      ...
                      previewImage.onload = () => {
                        this.player.debug.log(
                          `Preloaded thumb filename: ${newThumbFilename}`,
                        );
                        if (!this.loadedImages.includes(newThumbFilename))
        ...
        _defineProperty$1(
          this,
          "getHigherQuality",
          (currentQualityIndex, previewImage, frame, thumbFilename) => {
              ...
              if (previewImageHeight < this.thumbContainerHeight) {
                ...
                setTimeout(() => {
                  ...
                  if (this.showingThumbFilename === thumbFilename) {
                    this.player.debug.log(
                      `Showing higher quality thumb for: ${thumbFilename}`,
                    );
        ...
        _defineProperty$1(
          ...
          (toggle = false, clearShowing = false) => {
            const className =
              this.player.config.classNames.previewThumbnails
                .thumbContainerShown;
        ...
        _defineProperty$1(this, "setThumbContainerSizeAndPos", () => {
          ...
          if (!this.sizeSpecifiedInCSS) {
            ...
            imageContainer.clientHeight > 20 &&
            imageContainer.clientWidth < 20
          ) {
            const thumbWidth = Math.floor(
              imageContainer.clientHeight * this.thumbAspectRatio,
            );
            imageContainer.style.width = `${thumbWidth}px`;
          } else if (
            imageContainer.clientHeight < 20 &&
            ...
            const thumbHeight = Math.floor(
              imageContainer.clientWidth / this.thumbAspectRatio,
            );
        ...
        _defineProperty$1(this, "setThumbContainerPos", () => {
          ...
          const position =
            this.mousePosX - scrubberRect.left - container.clientWidth / 2;
    ...
    class Plyr {
      constructor(target, options) {
        ...
        _defineProperty$1(this, "rewind", (seekTime) => {
          this.currentTime -= is.number(seekTime)
            ? seekTime
         ...
         */
        _defineProperty$1(this, "supports", (type) =>
          support.mime.call(this, type),
        );
        this.timers = {};
